...
const Hero = () => {
    return (
        <div className='w-full flex flex-col gap-3 justify-evenly items-center sm:gap-5 sm:flex-row px-4'>
            <div className='w-[80%] sm:w-[50%] lg:w-[40%] h-fit border-8 bg-green rounded-[100%] border-purple overflow-hidden'>
            ...
            <div className="dark:text-white flex flex-col gap-3 sm:gap-5 items-center text-center sm:items-start">
                ...
                <div className="dark:text-white text-5xl flex gap-10 mt-3 justify-center items-center w-full">
